<x-app-layout>
    <div class="mb-8">
        <h1 class="text-2xl font-semibold text-slate-900">AI Dashboard</h1>
        <p class="mt-1 text-sm text-slate-500">Current view mode: <strong>{{ $dashboardConfig['layout'] }}</strong></p>
    </div>

<x-app-layout>
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-slate-900">Add Need</h1>
        <p class="mt-1 text-sm text-slate-500">Add a new need to {{ $goal->name }}</p>
    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" step="0.01" name="cost" id="cost" value="{{ old('cost') }}" class="pl-7 block w-full rounded-md border-slate-300 shadow-sm focus:border-slate-500 focus:ring-slate-500" required>
                        </div>
